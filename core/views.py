...
from transactions.constants import TransactionCategory, TransactionType
...
def home(request):
    ...
    budget_data = {
        TransactionCategory.NEEDS.value: {
            "budget": total_income
            * TransactionCategory.max_percentage(TransactionCategory.NEEDS.value)
            / 100,
            "spent": 0,
            "transactions": [],
        },
        TransactionCategory.WANTS.value: {
            "budget": total_income
            * TransactionCategory.max_percentage(TransactionCategory.WANTS.value)
            / 100,
            "spent": 0,
            "transactions": [],
        },
        TransactionCategory.SAVINGS.value: {
            "budget": total_income
            * TransactionCategory.max_percentage(TransactionCategory.SAVINGS.value)
            / 100,
            "spent": 0,
            "transactions": [],
        },
    ...
    context = {
        ...
        TransactionCategory.SAVINGS.value: budget_data[
            TransactionCategory.SAVINGS.value
        ],
    }
